...
namespace LicensePlateRecognition
{
    ...
    public class LicensePlateDetector : DisposableObject
    {
        ...
        public LicensePlateDetector(String dataPath)
        {
            ...
            _ocr = new TesseractEngine("C:/Users/sedgu/Documents/emgucv-windesktop 3.2.0.2682/Emgu.CV.Example/LicensePlateRecognition/obj/Debug/tessdata", "eng");
            //InitOcr("C:/Users/sedgu/Documents/emgucv-windesktop 3.2.0.2682/Emgu.CV.Example/LicensePlateRecognition/obj/Debug/", "eng", OcrEngineMode.TesseractCubeCombined);
#endif
        ...
        private void InitOcr(String path, String lang, OcrEngineMode mode)
        {
            try
            {
                ...
                _ocr = new TesseractEngine(pathFinal, lang);
            }
                    ...
                    if (CvInvoke.ContourArea(contour) > 400)
                    {
                        ...
                        using (UMat tmp2 = new UMat())
                        {
                            ...
                            using (UMat tmp = filteredPlate.Clone())
                            {
                                ...
                                if (_ocr.IsDisposed)
                                {
                                    strBuilder.Append(_ocr.Process(tmp.Bitmap, Tesseract.PageSegMode.Auto).GetText().Replace("\n", ""));
                                }
